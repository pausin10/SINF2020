...
BEGIN
    ...
    DECLARE minute int;
    DECLARE cursorTimer CURSOR FOR SELECT Ventas.* , Evento.TiempoPrereserva FROM Ventas INNER JOIN Evento on Ventas.idEvento = Evento.idEvento WHERE Ventas.comprada = 0;
